...
| Create initial frontend skeleton, connect to backend |                                     |
| Implement concepts in backend                        | Recipe: <br>User: <br>Collecting:   |
| Implement concept syncs in backend                   |                                     |
| Add tests for concepts in backend                    | Recipe: <br>User: <br>Collecting:   |
| Implement frontend functionality                     |                                     |
| Stylize + improve frontend usability                 |                                     |
